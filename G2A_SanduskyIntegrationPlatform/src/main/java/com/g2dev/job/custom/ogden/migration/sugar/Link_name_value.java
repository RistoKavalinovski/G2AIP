...
public class Link_name_value  implements java.io.Serializable {
    ...
    private com.g2dev.job.custom.ogden.migration.sugar.Link_value2[] records;
    ...
    public Link_name_value(
           ...
           com.g2dev.job.custom.ogden.migration.sugar.Link_value2[] records) {
           this.name = name;
     ...
     * @return records
     */
    public com.g2dev.job.custom.ogden.migration.sugar.Link_value2[] getRecords() {
        return records;
    }
     ...
     * @param records
     */
    public void setRecords(com.g2dev.job.custom.ogden.migration.sugar.Link_value2[] records) {
        this.records = records;
    }
