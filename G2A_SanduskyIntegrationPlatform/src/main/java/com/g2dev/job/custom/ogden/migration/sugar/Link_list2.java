...
public class Link_list2  implements java.io.Serializable {
    private com.g2dev.job.custom.ogden.migration.sugar.Link_name_value[] link_list;

    public Link_list2() {
    }

    public Link_list2(
           com.g2dev.job.custom.ogden.migration.sugar.Link_name_value[] link_list) {
     ...
     * @return link_list
     */
    public com.g2dev.job.custom.ogden.migration.sugar.Link_name_value[] getLink_list() {
        return link_list;
    }
     ...
     * @param link_list
     */
    public void setLink_list(com.g2dev.job.custom.ogden.migration.sugar.Link_name_value[] link_list) {
        this.link_list = link_list;
    }
