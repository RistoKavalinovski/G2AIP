...
public class New_return_note_attachment  implements java.io.Serializable {
    private com.g2dev.job.custom.ogden.migration.sugar.New_note_attachment note_attachment;

    public New_return_note_attachment() {
    }

    public New_return_note_attachment(
           com.g2dev.job.custom.ogden.migration.sugar.New_note_attachment note_attachment) {
     ...
     */
    public com.g2dev.job.custom.ogden.migration.sugar.New_note_attachment getNote_attachment() {
        return note_attachment;
    }
     ...
     */
    public void setNote_attachment(com.g2dev.job.custom.ogden.migration.sugar.New_note_attachment note_attachment) {
        this.note_attachment = note_attachment;
    }
