...
public class Get_mailmerge_document_result  implements java.io.Serializable {
    ...
    private com.g2dev.job.custom.sandusky.migration.sugar.Name_value[] name_value_list;
    ...
    public Get_mailmerge_document_result(
           ...
           com.g2dev.job.custom.sandusky.migration.sugar.Name_value[] name_value_list,
     ...
     */
    public com.g2dev.job.custom.sandusky.migration.sugar.Name_value[] getName_value_list() {
        return name_value_list;
    }
     ...
     */
    public void setName_value_list(com.g2dev.job.custom.sandusky.migration.sugar.Name_value[] name_value_list) {
        this.name_value_list = name_value_list;
    }
