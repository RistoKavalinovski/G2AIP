...
public class Return_search_result  implements java.io.Serializable {
    private com.g2dev.job.custom.tandem.migration.sugar.Search_link_name_value[] entry_list;

    public Return_search_result() {
    }

    public Return_search_result(
           com.g2dev.job.custom.tandem.migration.sugar.Search_link_name_value[] entry_list) {
     ...
     * @return entry_list
     */
    public com.g2dev.job.custom.tandem.migration.sugar.Search_link_name_value[] getEntry_list() {
        return entry_list;
    }
     ...
     * @param entry_list
     */
    public void setEntry_list(com.g2dev.job.custom.tandem.migration.sugar.Search_link_name_value[] entry_list) {
        this.entry_list = entry_list;
    }
