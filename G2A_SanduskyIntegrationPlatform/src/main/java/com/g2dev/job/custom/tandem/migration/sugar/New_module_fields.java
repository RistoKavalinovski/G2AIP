...
public class New_module_fields  implements java.io.Serializable {
    ...
    private com.g2dev.job.custom.tandem.migration.sugar.Field[] module_fields;

    private com.g2dev.job.custom.tandem.migration.sugar.Link_field[] link_fields;
    ...
    public New_module_fields(
           ...
           com.g2dev.job.custom.tandem.migration.sugar.Field[] module_fields,
           com.g2dev.job.custom.tandem.migration.sugar.Link_field[] link_fields) {
     ...
     */
    public com.g2dev.job.custom.tandem.migration.sugar.Field[] getModule_fields() {
        return module_fields;
    }
     ...
     * @param module_fields
     */
    public void setModule_fields(com.g2dev.job.custom.tandem.migration.sugar.Field[] module_fields) {
        this.module_fields = module_fields;
    }
     ...
     * @return link_fields
     */
    public com.g2dev.job.custom.tandem.migration.sugar.Link_field[] getLink_fields() {
        return link_fields;
    }
     ...
     * @param link_fields
     */
    public void setLink_fields(com.g2dev.job.custom.tandem.migration.sugar.Link_field[] link_fields) {
        this.link_fields = link_fields;
    }
