...
public class Get_relationships_result  implements java.io.Serializable {
    private com.g2dev.job.custom.sandusky.migration.sugar.Id_mod[] ids;
    ...
    public Get_relationships_result(
           com.g2dev.job.custom.sandusky.migration.sugar.Id_mod[] ids,
     ...
     * @return ids
     */
    public com.g2dev.job.custom.sandusky.migration.sugar.Id_mod[] getIds() {
        return ids;
    }
     ...
     * @param ids
     */
    public void setIds(com.g2dev.job.custom.sandusky.migration.sugar.Id_mod[] ids) {
        this.ids = ids;
    }
