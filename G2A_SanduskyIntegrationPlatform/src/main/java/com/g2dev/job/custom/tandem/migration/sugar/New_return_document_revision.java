...
public class New_return_document_revision  implements java.io.Serializable {
    private com.g2dev.job.custom.tandem.migration.sugar.Document_revision document_revision;

    public New_return_document_revision() {
    }

    public New_return_document_revision(
           com.g2dev.job.custom.tandem.migration.sugar.Document_revision document_revision) {
     ...
     */
    public com.g2dev.job.custom.tandem.migration.sugar.Document_revision getDocument_revision() {
        return document_revision;
    }
     ...
     */
    public void setDocument_revision(com.g2dev.job.custom.tandem.migration.sugar.Document_revision document_revision) {
        this.document_revision = document_revision;
    }
