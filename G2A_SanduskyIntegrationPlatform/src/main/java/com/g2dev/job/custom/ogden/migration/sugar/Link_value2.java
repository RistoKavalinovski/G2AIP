...
public class Link_value2  implements java.io.Serializable {
    private com.g2dev.job.custom.ogden.migration.sugar.Name_value[] link_value;

    public Link_value2() {
    }

    public Link_value2(
           com.g2dev.job.custom.ogden.migration.sugar.Name_value[] link_value) {
     ...
     * @return link_value
     */
    public com.g2dev.job.custom.ogden.migration.sugar.Name_value[] getLink_value() {
        return link_value;
    }
     ...
     * @param link_value
     */
    public void setLink_value(com.g2dev.job.custom.ogden.migration.sugar.Name_value[] link_value) {
        this.link_value = link_value;
    }
