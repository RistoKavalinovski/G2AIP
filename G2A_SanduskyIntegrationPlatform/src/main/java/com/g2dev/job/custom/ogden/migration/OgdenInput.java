...
public class OgdenInput extends SugarInput {

	private String moduleName;
	private Collection<String> selectFields;
	private int deleted = 0;

	public OgdenInput(String moduleName) {
		setModuleName(moduleName);
	}

	public OgdenInput(String moduleName, Collection<String> selectFields) {
		setModuleName(moduleName);
	...
	public static void main(String[] args) {
		// try {
		// Get_entry_list_result get_entry_list = OgdenSugarSession
