...
import com.g2dev.job.custom.sandusky.migration.rowListeners.OpportunityRowListener;
...
public class P_04_MigrateOpportunities extends MigrationProcess {
	...
	public void start() {
		...
		SugarOutputProcessorCSV output = new SugarOutputProcessorCSV(
				moduleName, map, new OpportunityRowListener(new AccountDedupe()));
