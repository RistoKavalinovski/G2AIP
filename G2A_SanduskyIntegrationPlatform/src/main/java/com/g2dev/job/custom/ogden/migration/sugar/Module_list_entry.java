...
public class Module_list_entry  implements java.io.Serializable {
    ...
    private com.g2dev.job.custom.ogden.migration.sugar.Acl_list_entry[] acls;
    ...
    public Module_list_entry(
           ...
           com.g2dev.job.custom.ogden.migration.sugar.Acl_list_entry[] acls) {
     ...
     * @return acls
     */
    public com.g2dev.job.custom.ogden.migration.sugar.Acl_list_entry[] getAcls() {
        return acls;
    }
     ...
     * @param acls
     */
    public void setAcls(com.g2dev.job.custom.ogden.migration.sugar.Acl_list_entry[] acls) {
        this.acls = acls;
    }
