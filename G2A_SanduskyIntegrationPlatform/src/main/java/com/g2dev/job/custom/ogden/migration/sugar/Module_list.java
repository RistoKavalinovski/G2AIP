...
public class Module_list  implements java.io.Serializable {
    private com.g2dev.job.custom.ogden.migration.sugar.Module_list_entry[] modules;

    public Module_list() {
    }

    public Module_list(
           com.g2dev.job.custom.ogden.migration.sugar.Module_list_entry[] modules) {
     ...
     * @return modules
     */
    public com.g2dev.job.custom.ogden.migration.sugar.Module_list_entry[] getModules() {
        return modules;
    }
     ...
     * @param modules
     */
    public void setModules(com.g2dev.job.custom.ogden.migration.sugar.Module_list_entry[] modules) {
        this.modules = modules;
    }
