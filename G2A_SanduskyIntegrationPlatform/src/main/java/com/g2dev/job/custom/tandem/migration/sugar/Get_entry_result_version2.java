...
public class Get_entry_result_version2  implements java.io.Serializable {
    private com.g2dev.job.custom.tandem.migration.sugar.Entry_value[] entry_list;

    private com.g2dev.job.custom.tandem.migration.sugar.Link_list2[] relationship_list;

    public Get_entry_result_version2() {
    }

    public Get_entry_result_version2(
           com.g2dev.job.custom.tandem.migration.sugar.Entry_value[] entry_list,
           com.g2dev.job.custom.tandem.migration.sugar.Link_list2[] relationship_list) {
     ...
     * @return entry_list
     */
    public com.g2dev.job.custom.tandem.migration.sugar.Entry_value[] getEntry_list() {
        return entry_list;
    }
     ...
     * @param entry_list
     */
    public void setEntry_list(com.g2dev.job.custom.tandem.migration.sugar.Entry_value[] entry_list) {
        this.entry_list = entry_list;
    }
     ...
     */
    public com.g2dev.job.custom.tandem.migration.sugar.Link_list2[] getRelationship_list() {
        return relationship_list;
    }
     ...
     */
    public void setRelationship_list(com.g2dev.job.custom.tandem.migration.sugar.Link_list2[] relationship_list) {
        this.relationship_list = relationship_list;
    }
