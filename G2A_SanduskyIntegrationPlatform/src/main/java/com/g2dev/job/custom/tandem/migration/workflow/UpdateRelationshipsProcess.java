...
public abstract class UpdateRelationshipsProcess {
	...
	public static String tandemQuery = null;
	...
	private static void u01UpdateAccounts() {
		...
		// String query = "market_c='Tandem'";
		String query = null;
		tandemQuery = "accounts.date_modified>20130000";
	...
	public static void updateModule(String moduleName,
			...
			String query) {/*
							 ...
							 * (session.loginForSandusky()) { TandemSugarSession
							 * tandemSession = TandemSugarSession.getInstance();
							 * if (tandemSession.loginForTandem()) { List<String>
							 ...
							 * tandemSession .getSugar()
							 * .get_entries_count(tandemSession.getSessionId(),
							 * moduleName, tandemQuery, 0) .getResult_count();
							 * 
							 * long startTime = System.currentTimeMillis();
							 * while (numberOfEntries > (offset + batchSize) ||
							 * offset == 0) {
							 * com.g2dev.job.custom.tandem.migration
							 * .sugar.Get_entry_list_result get_entry_list =
							 * tandemSession .getSugar().get_entry_list(
							 * tandemSession.getSessionId(), moduleName,
							 * tandemQuery, null, offset, selectFields,
							 ...
							 * .tandem.migration.sugar.Entry_value entry_value =
							 * entry_list[i];
							 * com.g2dev.job.custom.tandem.migration
							 ...
							 * com
							 * .g2dev.job.custom.tandem.migration.sugar.Name_value
