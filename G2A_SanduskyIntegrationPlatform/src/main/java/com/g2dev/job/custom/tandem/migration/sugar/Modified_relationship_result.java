...
public class Modified_relationship_result  implements java.io.Serializable {
    ...
    private com.g2dev.job.custom.tandem.migration.sugar.Modified_relationship_entry[] entry_list;

    private com.g2dev.job.custom.tandem.migration.sugar.Error_value error;
    ...
    public Modified_relationship_result(
           int result_count,
           int next_offset,
           com.g2dev.job.custom.tandem.migration.sugar.Modified_relationship_entry[] entry_list,
           com.g2dev.job.custom.tandem.migration.sugar.Error_value error) {
     ...
     * @return entry_list
     */
    public com.g2dev.job.custom.tandem.migration.sugar.Modified_relationship_entry[] getEntry_list() {
        return entry_list;
    }
     ...
     * @param entry_list
     */
    public void setEntry_list(com.g2dev.job.custom.tandem.migration.sugar.Modified_relationship_entry[] entry_list) {
        this.entry_list = entry_list;
    }
     ...
     * @return error
     */
    public com.g2dev.job.custom.tandem.migration.sugar.Error_value getError() {
        return error;
    }
     ...
     * @param error
     */
    public void setError(com.g2dev.job.custom.tandem.migration.sugar.Error_value error) {
        this.error = error;
    }
