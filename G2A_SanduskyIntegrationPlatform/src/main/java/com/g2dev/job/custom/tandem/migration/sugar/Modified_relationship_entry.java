...
public class Modified_relationship_entry  implements java.io.Serializable {
    ...
    private com.g2dev.job.custom.tandem.migration.sugar.Name_value[] name_value_list;
    ...
    public Modified_relationship_entry(
           ...
           com.g2dev.job.custom.tandem.migration.sugar.Name_value[] name_value_list) {
           this.id = id;
     ...
     */
    public com.g2dev.job.custom.tandem.migration.sugar.Name_value[] getName_value_list() {
        return name_value_list;
    }
     ...
     */
    public void setName_value_list(com.g2dev.job.custom.tandem.migration.sugar.Name_value[] name_value_list) {
        this.name_value_list = name_value_list;
    }
