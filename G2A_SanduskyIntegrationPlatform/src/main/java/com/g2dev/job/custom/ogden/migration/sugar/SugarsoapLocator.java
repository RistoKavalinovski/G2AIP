...
public class SugarsoapLocator extends org.apache.axis.client.Service implements com.g2dev.job.custom.ogden.migration.sugar.Sugarsoap {
    ...
    private java.lang.String sugarsoapPort_address = "https://ogden.askmsg.com/crm/service/v4_1/soap.php";
    ...
    public com.g2dev.job.custom.ogden.migration.sugar.SugarsoapPortType getsugarsoapPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.g2dev.job.custom.ogden.migration.sugar.SugarsoapBindingStub _stub = new com.g2dev.job.custom.ogden.migration.sugar.SugarsoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.g2dev.job.custom.ogden.migration.sugar.SugarsoapPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.g2dev.job.custom.ogden.migration.sugar.SugarsoapBindingStub _stub = new com.g2dev.job.custom.ogden.migration.sugar.SugarsoapBindingStub(new java.net.URL(sugarsoapPort_address), this);
                _stub.setPortName(getsugarsoapPortWSDDServiceName());
                return _stub;
            }
        }
