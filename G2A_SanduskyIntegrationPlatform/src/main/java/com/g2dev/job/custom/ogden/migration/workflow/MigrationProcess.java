...
public abstract class MigrationProcess {
	...
	public IntegrationMap buildMap(String module_name) {
		...
		if (ogdenSugarSession.loginForOgden()) {
			try {
				New_module_fields get_module_fields = ogdenSugarSession
						.getSugar().get_module_fields(
								ogdenSugarSession.getSessionId(), module_name,
								null);
	...
	public void defaultStart() {
		defaultStart(moduleName.toLowerCase() + ".date_modified>20150200");
	}
