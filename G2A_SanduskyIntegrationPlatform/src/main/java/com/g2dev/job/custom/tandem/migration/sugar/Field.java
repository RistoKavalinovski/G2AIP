...
public class Field  implements java.io.Serializable {
    ...
    private com.g2dev.job.custom.tandem.migration.sugar.Name_value[] options;
    ...
    public Field(
           ...
           int required,
           com.g2dev.job.custom.tandem.migration.sugar.Name_value[] options,
     ...
     * @return options
     */
    public com.g2dev.job.custom.tandem.migration.sugar.Name_value[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.g2dev.job.custom.tandem.migration.sugar.Name_value[] options) {
        this.options = options;
    }
