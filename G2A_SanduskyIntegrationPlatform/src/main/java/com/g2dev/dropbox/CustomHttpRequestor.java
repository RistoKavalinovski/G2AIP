 ...
 * </p>
 */
public class CustomHttpRequestor extends HttpRequestor {
	 ...
	 */
	public CustomHttpRequestor(Proxy proxy) {
		this.proxy = proxy;
	}
	 ...
	 * {@link #configureConnection}.
	 */
	public static final int DefaultReadTimeoutMillis = 85 * 1000;

	/**
	 * A thread-safe instance of {@code StandardHttpRequestor} that connects
	 * directly (as opposed to using a proxy).
	 */
	public static final CustomHttpRequestor Instance = new CustomHttpRequestor();
